...
class Login_Polimed:
    ...
    def Medicina_General(self):
        ...
        ############################################### Pestaña 1 #############################################
        self.Espacio_Emergencia2 = Label (self.pestana1, text= " ", bg="#C7D8D9").pack()
        self.Titulo_de_Apartado = Label(self.pestana1, text="Bienvenido a Medicina General", bg = "#C7D8D9", font= ("Comic Sans MS", 18)).pack()
        self.Espacio_Emergencia3 = Label (self.pestana1, text= " ", bg="#C7D8D9").pack()
        ################################# PESTAÑA 1 COMUNA 1 #################################################
        self.texto_deIntroduccion = Label(self.pestana1, text= "En la comuna 1 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana1, text= " ", bg="#C7D8D9")
        self.Espacio_Texto = Label (self.pestana1, text= "Santo Domingo 1, Nuevo Horizonte, Santo Domingo 2, Santa María La Torre, Popular 1, Popular 2 parte central, Popular 2 parte alta, Santa Cecilia 1, Santa Cecilia 2, Marco Fidel Suárez, Villa Guadalupe parte central, Villa Guadalupe parte baja, San Pablo 1, San Pablo 2, Granizal, La esperanza 2, El Compromiso, Carpinelo, La Avanzada, Nuestra Señora del Rocío. ", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana1, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c1.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana1, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia3 = Label (self.pestana1, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana1, text = "Cra.43b #108 - 6  Centro de salud popular 1 \n 3138313938",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana1, text = "Cra. 42 #20-92 Hospital Zamora \n 60444482030",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        ...
        ################################# PESTAÑA 2 COMUNA2 ###############################################
        self.texto_deIntroduccion = Label(self.pestana2, text= "En la comuna 2 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana2, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana2, text= "La Isla, La Frontera, Playón de los Comuneros, Pablo VI, La Francia, Andalucía, Villa del Socorro, Villa Niza, Moscú No. 1, Santa Cruz y La Rosa", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana2, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c2.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana2, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana2, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana2, text = "Cra.51A #100-50 Unidad intermedia santa cruz \n 300443322",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana2, text = "Cl. 105 #49-45 Centro de salud villa del socorro \n 6044756565",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana2, text = "Cra. 25 #1 Puesto de salud la cruz \n 604565430",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        

        self.Espacio_Emergencia3 = Label (self.pestana2, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana2,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana2, text= " ", bg="#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana2,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        
        ############################# PESTAÑA 3 COMUNA 3 ################################################
        self.texto_deIntroduccion = Label(self.pestana3, text= "En la comuna 3 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana3, text= " ", bg="#C7D8D9").pack()  
        self.Espacio_Texto = Label (self.pestana3, text= "La Salle, Las Granjas, Campo Valdés, Santa Inés, El Raizal, El Pomar, Manrique Central N.º 2, Manrique Oriental, Versalles N.º 1, Versalles N.º 2, La Cruz, La Honda, Oriente, María Cano - Carambola, San José La Cima N.º 1, San José La Cima N.º 2, Las Nieves", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana3, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c3.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana3, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack() 
        self.Espacio_Emergencia7 = Label (self.pestana3, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana3, text = "Cl. 71c #32-65 Centro de salud el raizal \n 4767574",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana3, text = "Cl. 66f #43-81 Unidad hospitalaria Manrique \n 6044446570",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana3, text = "Cll. 95A con Cra. 38 Hospital Pablo Tobon \n 604565740",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana3, text = "Cll 89 con Cra 36A Centro de salud San Blas \n 604354070",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana3, text = "Cra. 45 #83-42 Centro medico la samaritana \n 60444087027",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana3, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana3,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana3, text= " ", bg="#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana3,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
               
        ############################ PESTAÑA 4 COMUNA 4 ###################################################
        self.texto_deIntroduccion = Label(self.pestana4, text= "En la comuna 4 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana4, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana4, text= "Aranjuez, Berlín, San Isidro, Palermo, Bermejal - Los Álamos, Moravia, Sevilla, San Pedro, Manrique Central N.º 1, Campo Valdés N.º 1, Las Esmeraldas, La Piñuela, Brasilia, Miranda", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana4, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c4.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana4, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana4, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana4, text = "Cra. 51 #91 Consultorio medico San Cayetano \n 60442364076",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana4, text = "Cra. 50A #93-39 Centro de salud Aranjuez \n 604354233",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana4, text= " ", bg="#C7D8D9").pack()
        ...
        ########################## PESTAÑA 5 COMUNA 5 ####################################################
        self.texto_deIntroduccion = Label(self.pestana5, text= "En la comuna 5 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana5, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana5, text= "Castilla, Toscana, Héctor Abad Gómez, Las Brisas, Florencia, Téjelo, Boyacá, Belalcázar, Girardot, Tricentenario, Francisco, Antonio Zea, Alfonso López, Caribe, El Progreso, San Martin de Porres", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana5, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c5.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana5, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana5, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana5, text = "Cra. 65 #97-5 Copsana Ips sede norte \n 6044440051",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana5, text = "Cl. 98a #65-120 Unidad Intermedia Castilla \n 60444256440",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana5, text = "Cra. 65 #98-115 Metrosalud \n 6044543215",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana5, text = "Cll. 92ee #67-61 Hospital la María E.S.E \n 60444447192",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana5, text = "Cra. 70a #91-17 Centro de salud Alfonso Lopez \n 604564739",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana1, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana5,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana5, text= " ", bg="#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana5,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        
        ###################### PESTAÑA 6 COMUNA 6 #######################################################
        self.texto_deIntroduccion = Label(self.pestana6, text= "En la comuna 6 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana6, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana6, text= "Santander, Doce de Octubre No.1, Doce de Octubre No.2, Pedregal, La Esperanza, San Martín de Porres, Kennedy, Picacho, Picachito, Mirador del Doce, El Progreso No.2, El Triunfo", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana6, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c6.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana6, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana6, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana6, text = "Clle 108BB # 78-10 Unidad hospitalaria doce de octubre \n 60444782800",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana6, text = "Cl. 102 #83-99 Intermedia del doce \n 604657877",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana6, text = "83a-80, Cl. 104dd #83a-2 Salud total \n 6044508877",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana6, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana6,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana6, text= " ", bg="#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana6,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        
        ###################### PESTAÑA 7 COMUNA 7 #########################################################
        self.texto_deIntroduccion = Label(self.pestana7, text= "En la comuna 7 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana7, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana7, text= "Cerro El Volador, San Germán, Facultad de Minas, Universidad Nacional, La Pilarica, Bosques de San Pablo, Altamira, Córdoba, López de Mesa, El Diamante, Aures No.2, Aures No.1, Bello, Horizonte, Villa Flora, Palenque, Robledo, Cucaracho, Fuente Clara, Santa Margarita, Olaya Herrera, Pajarito, Monteclaro, Nueva Villa de la Iguaná", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana8, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c7.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana7, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana4, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana7, text = "Cll.82 #87-100 Centro de salud San Camilo \n 3014110358",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana7, text = "Cl. 78b #72 A-220 Clinica VID \n 3126543387",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana7, text = "Cra. 72A #78b - 50 Clina Universitaria bolivariana \n 6044455900",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana7, text = "Cl.78b #69-240 Hospital pablo tobon Uribe \n 6044459000",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana7, text = "Cl. 75 #75-29 Metrosalud centro de salud robledo \n 60442340070",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana7, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana7,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana7, text= " ", bg="#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana7,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        
        ####################### PESTAÑA 8 COMUNA 8 ########################################################
        self.texto_deIntroduccion = Label(self.pestana8, text= "En la comuna 8 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana8, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana8, text= "Villa Hermosa, La Mansión, Llanaditas, La Ladera, Golondrinas, Batallón, Girardot, San Miguel, Los, Mangos, Sucre, El Pinal, Las Perlas, Trece de Noviembre, La Libertad, Villatina, San Antonio, Las Estancias, Villa Turbay, La Sierra, Villa Lilliam, Esfuerzos de Paz N.º, Esfuerzos de Paz N.º 2, Enciso", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana8, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c8.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana8, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana8, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana8, text = "Cra. 17b#56e-61 Centro de salud sol de oriente \n 3106452233",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana8, text = "Cra.23 #56eh-1 Metro salud enciso \n 604456570",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana8, text = "Cra. 30 #58-100 Centro de salud enciso \n 604345423",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana8, text = "Cra.17a #54-63 Centro de salud villatina \n 604354657",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana8, text = "Cll.63 / Darien #41-27 Clinica Rosario \n 604453245",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana8, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana8,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana8, text= " ", bg="#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana8,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        
        ###################### PESTAÑA 9 COMUNA 9 ##########################################################
        self.texto_deIntroduccion = Label(self.pestana9, text= "En la comuna 9 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana9, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana9, text= "Buenos Aires, Caicedo, Juan Pablo II, Ocho de Marzo, Barrios de Jesús, Bomboná N.º 2, Los Cerros - El Vergel, Alejandro Echavarría, Miraflores, Cataluña, La Milagrosa, Gerona, El Salvador, Loreto, Asomadera N.º 1, Asomadera N.º, Asomadera N.º 3, Quinta Linda", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana9, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c9.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana9, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana9, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana9, text = "Cl.49a ##582 San ignacio 604567843",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana9, text = "Cra. 28a #38F Centro de salud loreto",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana9, text = "Cra. 29 #4215 Consultorio la milagrosa \n 6044448318",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana9, text = "Cl. 49 #35 - 61 Nueva clinica sagrado corazón \n 6042151000",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana9, text = "Cra. 36 #40 a-30 Centro de salud el salvador \n 60442173194  ",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana9, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana9,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana9, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana10, text= "En la comuna 10 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana10, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana10, text= "La Candelaria, Prado, Jesús, Nazareno, El Chagualo, Estación Villa, San Benito, Guayaquil, Corazón de Jesús, Barrio Triste, Calle Nueva, Perpetuo Socorro, Barrio Colón, Las Palmas, Bomboná N.º 1, Boston, Los Ángeles, Villa Nueva, San Diego", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana10, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c10.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana10, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana10, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana10, text = "Cl 50 N°46B-60 Coosalud EPS \n 60448372880 ",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana10, text = "Cl 50 #46 36 colmedicos S.A.S \n 60445100500",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana10, text = "Cra. 46 #47-66 IPS Esalud \n 3016569147",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana10, text = "Cl. 51 #45-93 Clinica Soma \n 6045768400",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana10, text = "Cra. 45 #5063 Nueva Eps \n 6044335540",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas6 = Label(self.pestana10, text = "a 49-124, Av carabobo #492 Congracion Mariana",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas7 = Label(self.pestana10, text = "Cra. 49 #58-19 Clinica Victoriana",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas8 = Label(self.pestana10, text = "Cra.56c #50-56 Fundacion Medico preventiva sede colombia \n 314220870",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana10, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana10,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana10, text= " ", bg="#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana11, text= "En la comuna 11 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana11, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana11, text= "Los Conquistadores, Laureles, Carlos E. Restrepo, suramericana, Naranjal, San Joaquín, Bolivariana, Las Acacias, La Castellana, Lorena, El Velódromo, Estadio, Los Colores, Cuarta, Brigada, Florida Nueva, Los Almendros", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana11, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c11.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana11, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana11, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana11, text = "Cl. 47D #70-155 IPS \n 604543422",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana11, text = "Cra.72 #44-57 Florida Nueva \n 604432244",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana11, text = "a 34-156,Dg. 66A #34-2 Santa lucia \n 604454454",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana11, text = "Calle 66b #34A-76 Local 242 DR.Angel Contreras \n 3008828295",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana11, text = "Cl. 44A #79-145 Salud total \n 018000114524",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas6 = Label(self.pestana11, text = "Av. 80 #49a-68 Coopsana IPS \n 6044440051",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana11, text= " ", bg="#C7D8D9").pack()     
        self.BotonVolver = Button(self.pestana11,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana11, text= " ", bg="#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana12, text= "En la comuna 12 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana12, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana12, text= "La América, Ferrini, Calasanz, Los Pinos, La Floresta, Santa Lucía, El Danubio, Campo Alegre, Santa Mónica, Barrio Cristóbal, Simón Bolívar, Santa Teresita, Calasanz Parte Alta", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana12, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c12.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana12, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana12, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana12, text = "Cra. 70 #1-141 Clinica las americas \n 604434455",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana12, text = "Dg.75B #2 A - 80 Torre 2 Torre Medica las americas \n 6043417070",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana12, text = "Dg. 75B #2A-80/140 Clinica Las Americas Auna \n 6043421010",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana12, text = "Diagonal 75 Dra.Clemencia Duque Vera \n 3136460299",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana12, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana12,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana12, text= " ", bg="#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana13, text= "En la comuna 13 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana13, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana13, text= "San Javier N.º 1, San Javier N.º 2, El Pesebre, Blanquizal, Santa Rosa de Lima, Los Alcázares, Metropolitano, La Pradera, Juan XXIII, La Divisa, Veinte de Julio, Belencito, Betania, El Corazón, Las Independencias, Nuevos, Conquistadores, El Salado, Eduardo Santos, Peñitas, Antonio Nariño, El Socorro, Calasania, La Asomadera", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana13, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c13.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana13, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana13, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana13, text = "Cra.105b #34bb-30 Centro de salud villa laura \n 60444920838",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana13, text = "a 39a-7, Cra. 118 #39a1 Centro de salud cuatro esquinas, la Esperanza \n 3004103000",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana13, text = "Cl. 40 veinte de julio Centro de salud San Javier \n 60442520100",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana13, text = "39b-64, Cra.109 #39b-2 Consultorio medico San vicente \n 60442537417",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana13, text= " ", bg="#C7D8D9").pack()      
        self.BotonVolver = Button(self.pestana13,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana13, text= " ", bg="#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana14, text= "En la comuna 14 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana14, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana14, text= "Castropol, Barrio Colombia, Ciudad del Rio, Villa Carlota, Lalinde, Manila, Las Lomas N.º 1, Las Lomas N.º 2, Altos del Poblado, El Tesoro, Los Naranjos, Los Balsos N.º 1, Los Balsos N.º 2, San Lucas, El Diamante, El Castillo, Alejandría, La Florida, El Poblado, Astorga, Patio Bonito, La Aguacatala, Santa María de Los Ángeles", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana14, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c14.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana14, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana14, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana14, text = "Cra. 46 #27-35 Colsanitas IPS \n 60443548871",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana14, text = "Cra. 43 Colsanitas Av.poblado \n 6045675544",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana14, text = "Cl. 19a #44-25 Torre medica salud y servicios \n 3102576598",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana14, text = "Cra. 48 #10-45 Botero sanin \n 6044445523 ",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas7 = Label(self.pestana14, text = "Cl. 14 #43b-9 Metrosalud \n 60445117505",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas8 = Label(self.pestana14, text = "Cl. 7 #39-290 Clinica medellin \n 6043112800",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas9 = Label(self.pestana14, text = "Cl. 7 #39 - 290 piso 3 CediMed S.A.S \n 60446040138",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana14, text= " ", bg="#C7D8D9").pack()     
        self.BotonVolver = Button(self.pestana14,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana14, text= " ", bg="#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana15, text= "En la comuna 15 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana15, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana15, text= "Tenche, Trinidad, Santa Fe, Campo Amor, Cristo Rey, Guayabal, La Colina", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana15, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c15.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana15, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana15, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana15, text = "Cl. 1 sur #51B-36 Consult. medico \n 60442852682",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana15, text = "Cl. 1 #53 - 57 Centro de salud Sura \n 604443434",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana15, text = "Cl. 1c #65-85 EPS Guayabal \n 6044335533",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana15, text = "Cl. 78 #52d-141 Comfama Santa María IPS \n 604564433",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana15, text = "Carrera 55, Cl. 78 Sura EPS Comfama \n 604432244",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia3 = Label (self.pestana15, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana15,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana15, text= " ", bg="#C7D8D9").pack()
        ...
        self.texto_deIntroduccion = Label(self.pestana16, text= "En la comuna 16 podemos encontrar localidades de la ciudad de Medellín como lo son : \n", wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.Espacio_Emergencia1 = Label (self.pestana16, text= " ", bg="#C7D8D9").pack()
        self.Espacio_Texto = Label (self.pestana16, text= "Belén, Rodeo Alto, Aguas Frías, Cerro Nutibara, Fátima, Rosales, Granada, San Bernardo, Las Playas, Diego Echavarria, La Mota, El Rincón, La Hondonada, La, Loma de Los Bernal, La Gloria, Altavista, La Palma Zafra, Los Alpes, Las Violetas, Las Mercedes, Nueva Villa de Aburrá, Miravalle, El Nogal - Los Almendros", bg="#C7D8D9", wraplength= 800, font =("", 16)).pack()
        self.Espacio_Emergencia8 = Label (self.pestana16, text= " ", bg="#C7D8D9").pack()
        self.image = Image.open("c16.png")
        self.image = self.image.resize((270,269),Image.Resampling.LANCZOS)
        imagen_comuna = ImageTk.PhotoImage(self.image)
        label_Logo = Label(self.pestana16, image = imagen_comuna, bg="#C7D8D9")
        label_Logo.image = imagen_comuna
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana16, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana16, text = "#75,cq. 5 #42 centro medico la mota \n 6042565075 ",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas2 = Label(self.pestana16, text = "Dg. 75B #5-106 Coomeva EPS \n 60444156000",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas3 = Label(self.pestana16, text = "Cl. 2b #100 Centro de salud Belen Rincón \n 6042388000",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas4 = Label(self.pestana16, text = "Cra. 84a #15A - 15 Consultorio medico \n 60443415509",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas5 = Label(self.pestana16, text = "Cra. 83 # 27 consultorio medico \n 3162064037",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas6 = Label(self.pestana16, text = "Cll 28 entre Cra 79A Centro de salud belen \n 60443332439 ",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()
        self.texto_Comunas7 = Label(self.pestana16, text = "Dg. 74B belen Ips sevid \n 60444116592",wraplength= 500, font =("", 16), bg="#C7D8D9").pack()

        self.Espacio_Emergencia3 = Label (self.pestana16, text= " ", bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana16,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.segundo_toplevel).pack()
        self.Espacio_Emergencia2 = Label (self.pestana16, text= " ", bg="#C7D8D9").pack()
...
########################################## 3re Toplevel ###############################
    ...
    def cuarta_ventana(self):
        self.ventana5.withdraw()
        self.ventana2 = Toplevel()
        w, h = self.ventana2.winfo_screenwidth(), self.ventana2.winfo_screenheight()
        self.ventana2.geometry("%dx%d+450+260"%(w/2,h/2))
        self.ventana2.config(bg="#C7D8D9") 
    ...
    def optometria(self):
        ...
        self.Espacio_Emergencia99= Label(self.pestana1, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana1,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas2 = Label(self.pestana2, text = "",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana2,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana2, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana2,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.Espacio_Emergencia99= Label(self.pestana3, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana3,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas5 = Label(self.pestana4, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana4,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana4, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana4,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas6 = Label(self.pestana5, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana5,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana5, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana5,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas3 = Label(self.pestana6, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana6,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana6, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana6,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas6 = Label(self.pestana7, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana7,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana7, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana7,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas5 = Label(self.pestana8, text = " ",wraplength= 350, bg="#C7D8D9").pack()   
        self.BotonVolver = Button(self.pestana8,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana8, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana8,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas5 = Label(self.pestana9, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        ...
        self.texto_Comunas10 = Label(self.pestana10, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana10,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana10, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana10,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas6 = Label(self.pestana11, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana11,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana11, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana11,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas6 = Label(self.pestana12, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana12,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana12, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana12,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas2 = Label(self.pestana13, text = "",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana13,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana13, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana13,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.texto_Comunas123 = Label(self.pestana14, text = " ",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana14,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana14, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana14,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        label_Logo.pack()
        self.Espacio_Emergencia7 = Label (self.pestana16, text= " ", bg="#C7D8D9").pack()
        self.texto_Comunas = Label(self.pestana16, text = "Cra. 70 #1 - 18 Local 377 Lafam-Arkadia \n 316349",wraplength= 350, bg="#C7D8D9", font =("", 16)).pack()
        self.texto_Comunas2 = Label(self.pestana16, text = "",wraplength= 350, bg="#C7D8D9").pack()
        self.BotonVolver = Button(self.pestana16,text= "Regresar", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.tercer_toplevel).pack()
        self.Espacio_Emergencia99= Label(self.pestana16, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana16,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
    ...
    def instrucctivo(self):
        ...
        label_Logo2.pack()
        self.Espacio_Emergencia1= Label(self.pestana1, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.Boton_Volver = Button(self.pestana1, text= "Regresar",  bg = "#C7D8D9", command=self.cuarta_ventana, font =("Comic Sans MS", 12)).pack()
        self.Espacio_Emergencia99= Label(self.pestana1, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana1,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ...
        self.Espacio_Emergencia4= Label(self.pestana2, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.Boton_Volver = Button(self.pestana2, text= "Regresar",  bg = "#C7D8D9", command=self.cuarta_ventana, font =("Comic Sans MS", 12)).pack()
        self.Espacio_Emergencia99= Label(self.pestana2, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.BotonCerrar = Button(self.pestana2,text= "Salir", bg = "#C7D8D9", font =("Comic Sans MS", 12), command= self.Cerrar_ventana).pack()
        ############################### Pestaña 3 Creditos de la APP #########################################
        self.Texto_pestana_ = Label(self.pestana3, text ="ANA \n Yhojan \n Milton",wraplength= 700, font=( "", 20), bg="#C7D8D9").pack()
        self.Espacio_Emergencia99= Label(self.pestana3, text = " ", font=("Comic Sans MS",14), bg = "#C7D8D9").pack()
        self.Boton_Volver = Button(self.pestana3, text= "Regresar",  bg = "#C7D8D9", command=self.cuarta_ventana, font =("Comic Sans MS", 12)).pack()
